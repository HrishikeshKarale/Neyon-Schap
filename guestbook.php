						...
						<div id="content">
							<div id="leftt">
										...
										<table id="tableg">
															  <tr>
																  ...
																  <td >
																  		...
																  		<input class="tab" type="text" name="gbname">
															...
															<tr>
																    ...
																    <td>
																  		...
																  		<input class="tab" type="text" name="gbemail" maxlength="100">
															...
															<tr>
																    ...
																    <td >
																		 ...
																		 <textarea name="gbmessage" style="width: 250px; height: 90px" ></textarea></td>
															  </tr>
								...
								<?php
									...
									$entriess = mysql_query("SELECT * From entries ORDER BY 'timestamp' DESC");
									if(@mysql_num_rows($entriess)==0)
									{
										echo 'NO ENTRIES YET';
									}
									else
									{
										echo '<table id=guest>';
										while( $entriess_row = mysql_fetch_assoc($entriess))
										{
											$entriess_timestamp = $entriess_row['timestamp'];
											$entriess_name = $entriess_row ['name'];	
											$entriess_email = $entriess_row ['email']	;
											$entriess_message = $entriess_row ['message'];
											...
											echo '<tr>
														...
														<td class="g">
																'.$entriess_name.'&nbsp;(&nbsp;<t id="email">'.$entriess_email.'</t>&nbsp;)&nbsp;<tt id="on"> On </tt>&nbsp;<ttt id="date">'.$entriess_timestamp.'</ttt>
														</td>
													</tr>
													<tr>
														<td >
